...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand" >Dekomposer</a>
  ...
  <!-- Page Header -->
  <header class="masthead" style="background-image: url('img/headline decomposer.jpg')">
      ...
      <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
          <div class="site-heading">
            <h1>Dekomposer </h1>
            <h2> Punya limbah organik dan bingung mau diapain  ?</h2>
    ...
    <div class="row">
      <div class="col-lg-8 col-md-10 mx-auto">
        <div class="post-preview">
          ...
          <a href="artikel/dekomposer/{{ $artikel -> id }}">
            <h2 class="post-title">
