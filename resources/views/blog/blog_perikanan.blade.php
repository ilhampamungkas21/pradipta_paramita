...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand" >Perikanan</a>
  ...
  <!-- Page Header -->
  <header class="masthead" style="background-image: url('img/headline perikanan.jpg')">
      ...
      <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
          <div class="site-heading">
            <h1>Perikanan</h1>
            <h2>Ternak Sehat tanpa efek samping dalam 7 Hari. Mau ?</h2>
