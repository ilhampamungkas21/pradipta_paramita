...
<body>
  ...
  <!-- Page Header -->
  <header class="masthead" style="background-image:url({{url('img/isi_lalat.jpg')}})  ">
      ...
      <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
          <div class="post-heading">
           ...
           <h2 class="subheading">Lalat Hilang Rejeki datang</h2>
            <span class="meta">Di Pos oleh CV.Pradipta Paramita</span>
          </div>
        </div>
      </div>
    </div>
