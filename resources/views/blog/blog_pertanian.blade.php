...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand" >Pertanian</a>
  ...
  <!-- Page Header -->
  <header class="masthead" style="background-image: url('img/headline pertanian.jpg')">
      ...
      <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
          <div class="site-heading">
            <h1>Pertanian</h1>
            <h2>Omset Naik tanpa gagal panen . Mau ?</h2>
    ...
    <div class="row">
      <div class="col-lg-8 col-md-10 mx-auto">
        <div class="post-preview">
          ...
          <a href="artikel/pertanian/{{ $artikel -> id }}">
            <h2 class="post-title">
